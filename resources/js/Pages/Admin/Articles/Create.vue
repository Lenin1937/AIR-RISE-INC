...
<template>
    ...
    <AdminLayout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-white tracking-tight">Create New Article</h1>
                <p class="text-[13px] text-gray-500 mt-1">Add a new article to your knowledge base</p>
            </div>
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6">
                ...
                <input v-model="form.title" type="text" required placeholder="Enter article title" :class="inp"/>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6">
                ...
                <textarea v-model="form.excerpt" rows="3" maxlength="500" required placeholder="Brief description of the article"
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6">
                ...
                <RichTextEditor v-model="form.content" placeholder="Write your article content here..."/>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input v-model="form.author" type="text" required placeholder="Author name" :class="inp"/>
                ...
                <div>
                    ...
                    <input v-model="form.tags" type="text" placeholder="Delaware, LLC, Business Formation" :class="inp"/>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit" :disabled="processing || form.processing"
                        ...
                        <svg v-if="processing || form.processing" class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                        </svg>
                        {{ (processing || form.processing) ? 'Creating…' : 'Create Article' }}
                    </button>
                </div>
            </div>
