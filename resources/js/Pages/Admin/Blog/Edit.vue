...
const form = useForm({
    ...
    author:           props.post.author ?? 'CORPIUS Team',
...
const existingImage = ref(props.post.image_url);
...
const currentImage = ref(existingImage.value || imagePreview.value);
</script>
    ...
    <AdminLayout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-[13px] text-gray-500 mt-1 truncate max-w-lg">{{ post.title }}</p>
            </div>
            <div class="flex items-center gap-3 self-start sm:self-auto">
                ...
                <a v-if="post.published" :href="route('blog.show', post.slug)" target="_blank"
            ...
            <div v-if="aiPanel" class="mb-6 rounded-2xl border border-violet-500/30 bg-violet-500/[0.06] p-6">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-[12px] text-gray-500">Enter a topic and Gemini AI will rewrite the entire post — existing content will be replaced</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <button type="button" @click="generateWithAI"
                        ...
                        {{ aiGenerating ? 'Generating… (30-60 sec)' : 'Generate & Replace' }}
                    </button>
        ...
        <form @submit.prevent="submitForm" class="space-y-6" enctype="multipart/form-data">
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6">
                ...
                <div v-if="imagePreview || existingImage" class="mb-4 relative group w-full max-w-lg">
                    <img :src="imagePreview || existingImage" alt="Post image" class="w-full h-56 object-cover rounded-xl border border-white/[0.08]"/>
                ...
                <label v-if="!imagePreview && !existingImage"
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-2">Read Time (min)</label>
                    <input v-model="form.read_time" type="number" min="1" max="120" :class="inp"/>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6">
                ...
                <textarea v-model="form.excerpt" rows="3" maxlength="600" :class="area"></textarea>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input v-model="form.author" type="text" :class="inp"/>
                </div>
                <div>
                    ...
                    <input v-model="form.tags" type="text" :class="inp"/>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-white/[0.07] bg-[#0c1c30] p-6 space-y-4">
                ...
                <div>
                    ...
                    <input v-model="form.meta_title" type="text" :class="inp"/>
                </div>
                <div>
                    <label class="block text-[10px] text-gray-600 mb-1.5">Meta Description</label>
                    <textarea v-model="form.meta_description" rows="2" maxlength="500" :class="area"></textarea>
                </div>
            </div>
